    ...
    <header class="header_sec">
        <div class="container">
            ...
            <div class="header_contents">
                ...
                <div class="socials">
                    <ul class="social_links"><a target="_blank"
                            href="https://www.facebook.com/profile.php?id=100079941048298"><i
                                class="fa-brands fa-facebook-f fa-3x" style="color: white;"></i></a></ul>
                    <ul class="social_links"><a target="_blank" href="https://github.com/AHMED-SAFA"><i
                                class="fa-brands fa-github fa-3x" style="color: white;"></i></a></ul>
                    <ul class="social_links"><a target="_blank" href="https://www.linkedin.com/in/ahmedsafa114/"><i
                                class="fa-brands fa-linkedin-in fa-3x" style="color: white"></i></a></ul>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="infos">
                ...
                <div class="intro">
                    ...
                    <div class="rightSide">
                        ...
                        <h3 style="font-size: 30px;margin-bottom: 20px;"><span style="color: rgb(46, 233, 239);"
                                class="txt-type" data-wait="2000"
                                data-words='["Engineer","Programmer","Developer","Learner"]'></span>
                        </h3>
